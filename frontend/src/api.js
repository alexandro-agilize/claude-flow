...
export const listVariables       = ()          => api.get('/variables');
export const createVariable      = (data)      => api.post('/variables', data);
export const updateVariable      = (id, data)  => api.put(`/variables/${id}`, data);
